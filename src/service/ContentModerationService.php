...
class ContentModerationService
{
    ...
    /** Public alias used by BlogModerationAnalyzer to avoid duplicate word lists. */
    public function detectProfanityWords(string $text): array
    {
        return $this->detectBadWords($text);
    }
